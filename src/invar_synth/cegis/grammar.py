...
from invar_synth.cegis.cex import CEX, ImplicationCEX
...
""")
    ...
    def get_synth_str(self, tmpl_qs, tmpl_sorts, counter_examples, known_invars, lazy_witness=False):
        ...
        for cex in counter_examples:
            ...
            arg_values = [cex.M.get_universe(s) for s in tmpl_sorts]
        ...
        unique_invar_asserts = self._get_unique_invar_asserts(
            tmpl_sorts, synthesized_inv, universes, known_invars, lazy_witness
        )
        # unique_invar_asserts = ""
    ...
    def _get_unique_invar_asserts(self, tmpl_sorts, synthesized_inv, universes, known_invars, lazy=False):
